...
<head>
    ...
    <title>Réparation Trottinettes Électriques</title>
...
<body>
    ...
    <section class="section" style="padding: 40px 0 20px 0;">
        <div class="container text-center">
            ...
            <h1 class="section-title" style="margin-top: 10px; color: #f8fafc;">Réparation Trottinette Électrique</h1>
            <p style="color: #94a3b8; margin-top: 8px;">Crevaison, freinage, électronique, étanchéité... On remet votre engin en route !</p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="services-block">
                <h3 class="services-section-title">
                    <svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/><line x1="12" y1="2" x2="12" y2="8"/><line x1="12" y1="16" x2="12" y2="22"/></svg>
                    Nos prestations trottinettes
                </h3>
                <?php render_category_services('reparations-trottinettes'); ?>
            </div>

            <!-- APPEL À L'ACTION -->
            <div class="cta-box">
                <h3>Besoin d'un devis rapide ?</h3>
                <p>Passez en atelier ou contactez-nous avec la marque et le modèle (ex: Xiaomi M365, Ninebot Max G30).</p>
                <a href="contact.html" class="btn btn--secondary" style="background:#10b981; color:#0b0f17; padding: 12px 25px; border-radius: 8px; font-weight: 600; text-decoration: none; display: inline-block;">Prendre Contact</a>
            </div>
