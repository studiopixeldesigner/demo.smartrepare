...
<head>
    ...
    <title>Réparation Consoles de Jeux - Smart Repare</title>
...
<body>
    ...
    <section class="section" style="padding: 40px 0 20px 0;">
        <div class="container text-center">
            ...
            <h1 class="section-title" style="margin-top: 10px; color: #f8fafc;">Réparation Consoles de Jeux</h1>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="services-block">
                <h3 class="services-section-title">
                    <svg viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="6" width="20" height="12" rx="6"/><line x1="6" y1="12" x2="10" y2="12"/><line x1="8" y1="10" x2="8" y2="14"/><circle cx="15" cy="13" r="1"/><circle cx="18" cy="11" r="1"/></svg>
                    Nos prestations consoles
                </h3>
                <?php render_category_services('reparation-console'); ?>
            </div>

            <!-- APPEL À L'ACTION -->
            <div class="cta-box">
                <h3>Une question ou besoin d'un devis précis ?</h3>
                <p>Chaque console et chaque panne étant unique (port HDMI arraché, surchauffe, écran cassé), nous réalisons un diagnostic gratuit en atelier afin de vous proposer le tarif le plus juste.</p>
